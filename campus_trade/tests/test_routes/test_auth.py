...
class TestAuthRoutes:
    ...
    def test_register_duplicate_username(self, client, app):
        ...
        with app.app_context():
            create_user("dupuser", "20001", "Pass1234", "广州新港校区")
    ...
    def test_register_duplicate_student_id(self, client, app):
        """Duplicate student ID triggers validation error."""
        with app.app_context():
            create_user("user1", "20010", "Pass1234", "广州新港校区")
    ...
    def test_login_success(self, client, app):
        ...
        with app.app_context():
            create_user("loginuser", "30001", "Pass1234", "广州新港校区")
    ...
    def test_login_wrong_password(self, client, app):
        ...
        with app.app_context():
            create_user("failuser", "30003", "Pass1234", "广州新港校区")
    ...
    def test_logout(self, client, app):
        ...
        with app.app_context():
            create_user("logoutuser", "30004", "Pass1234", "广州新港校区")
    ...
    def test_already_logged_in_redirects_login_page(self, client, app):
        ...
        with app.app_context():
            create_user("rediruser", "30005", "Pass1234", "广州新港校区")
